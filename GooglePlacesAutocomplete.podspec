Pod::Spec.new do |spec|
  spec.name = "ZyblerGooglePlacesAutocomplete"
  spec.version = "0.3.0"
  spec.summary = "Simple Google Places autocompleting address entry view"
  spec.homepage = "https://github.com/azybler/ios_google_places_autocomplete"
  ...
  spec.source = { :git => "https://github.com/azybler/ios_google_places_autocomplete.git", :tag => spec.version.to_s }
